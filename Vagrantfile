Vagrant.configure("2") do |config|
  config.vm.define "server_vm" do |server_vm|
    server_vm.vm.box = "ubuntu/jammy64"
    server_vm.vm.provider "vmware_desktop"

    server_vm.vm.network "private_network", ip: "192.168.56.10"
    config.vm.synced_folder "./suricata_shared", "/home/vagrant/suricata_shared"
    ...
    server_vm.vm.provision "shell", inline: <<-SHELL
      ...
      cp /vagrant/src/opcua_server.py /home/vagrant/opcua_example/opcua_server.py
  ...
  config.vm.define "client_vm" do |client_vm|
    client_vm.vm.box = "ubuntu/jammy64"
    ...
    client_vm.vm.provision "shell", inline: <<-SHELL
      ...
      mkdir -p /home/vagrant/opcua_example
      cp /vagrant/src/opcua_client.py /home/vagrant/opcua_example/opcua_client.py
      pip3 install opcua
